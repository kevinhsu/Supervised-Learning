function [MSE_table] = LSRdimensionality
...
% 100 element-size training set with 10 dimension. Repeat 200 times.
for i = 1:iteration
    l = 100;
...
% 10 element-size training set with 10 dimension. Repeat 200 times.
for i = 1:iteration
    l = 10;
    [MSE_train(i), MSE_test(i)] = LSR(l, M, N);
end
